...
impl WriteQueue {
    ...
    async fn get_latest_segment(
        ...
        // This is safe we should always have a valid segment otherwise better to crash.
...
mod tests {
    ...
    async fn append() {
        ...
        let appendables = vec![b"hello"; 20];

        for appendable in appendables {
            println!("buf before append {:?}", appendable);
